		...
		<div style="margin:0 auto; text-align:center"> </div>
			...
			<script language="javascript">
				...
				<div class="col-md-4">
					...
					<div class="card-deck">
					  <div class="img-set1">
					      <img class="fancybox" src="{{asset('img/to.png')}}" title="" height="110" width="935"/>
					    </div>					  
					</div>
				</div>
			</div>		
			...
			<div class="row">
				...
				<div class="col-md-3">
					...
					<div class="card-deck">
						<h1>{{($img->title)}}</h1>
					  <div class="img-set1">
					      <img class="fancybox" src="{{asset('newsimages/'.$img->image)}}" title="{{($img->category)}}" height="500" width="920"/>
					    </div>					  
					</div>
					@endforeach
				</div>
